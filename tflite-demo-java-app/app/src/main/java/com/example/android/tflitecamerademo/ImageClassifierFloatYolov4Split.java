...
public class ImageClassifierFloatYolov4Split extends ImageClassifier {
     ...
     * @param activity
     */
    ImageClassifierFloatYolov4Split(Activity activity) throws IOException {
        super(activity);
        labelProbArray = new float[1][13][13][90];
    }
    ...
    protected String getModelPath() {
        ...
        return "yolov4_split_model.tflite";
    }
