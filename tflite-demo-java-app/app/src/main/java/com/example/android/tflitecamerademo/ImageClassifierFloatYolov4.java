...
public class ImageClassifierFloatYolov4 extends ImageClassifier {
   ...
   * @param activity
   */
  ImageClassifierFloatYolov4(Activity activity) throws IOException {
    super(activity);
      labelProbArray = new float[1][13][13][75];
  }
