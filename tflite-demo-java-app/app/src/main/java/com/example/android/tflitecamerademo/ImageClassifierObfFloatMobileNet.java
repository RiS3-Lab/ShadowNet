...
public class ImageClassifierObfFloatMobileNet extends ImageClassifier {
   ...
   * @param activity
   */
  ImageClassifierObfFloatMobileNet(Activity activity) throws IOException {
    super(activity);
  ...
  protected String getModelPath() {
    ...
    return "mobilenet_v1_1.0_224_obf.tflite";
  }
